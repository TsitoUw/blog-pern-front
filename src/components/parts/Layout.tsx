  ...
  return (
    <div className="relative">
      <div className="navbar | p-2 bg-slate-900 flex justify-between w-full top-0 left-0 sticky backdrop-blur-md bg-opacity-80 " >
        <NavLink to={user?.currentUser?"/":"/welcome"} className="text-white p-2 w-2/12 flex items-center justify-start"><GraphicEqIcon className='text-rose-600'/> Musicc</NavLink>
